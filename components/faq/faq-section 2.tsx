  ...
  return (
    <section id="faq" className="py-16">
      <div className="mx-auto max-w-4xl px-6">
        {/* Header */}
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold text-foreground">{t("faq.title")}</h2>
          <p className="text-lg text-foregroundMuted">{t("faq.description")}</p>
        </div>
                  ...
                  >
                    <div className="px-6 pb-4">
                      <div className="border-t border-outline pt-4">
                        <p className="leading-relaxed text-foregroundMuted">{answer}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
