...
<p>You are fully responsible for the security of your MetaMask wallet and private keys. We cannot recover funds lost due to your wallet compromise.</p>`,
    ...
    internalPayout: {
      ...
      helper: "Requests are processed within 2 hours. We will inform you about the status via email/Telegram.",
...
<p>Jūs esate visiškai atsakingas už savo MetaMask piniginės ir privatinių raktų saugumą. Mes negalime atkurti lėšų, prarastų dėl jūsų piniginės kompromitavimo.</p>`,
    ...
    internalPayout: {
      badge: "Ižininkystė",
      title: "Išėmimas į korporacinę piniginę",
      description:
        "Sukurkite užklausą ir nurodykite išėmimo adresą. Balansas rezervuojamas akimirksniu, o ižininkystės komanda patvirtina operaciją rankiniu būdu.",
      helper: "Užklausos apdorojamos per 2 valandas. Apie būseną pranešime el. paštu/Telegram.",
      amountLabel: "Suma žetonais",
      addressLabel: "Piniginės adresas išėmimui",
      noteLabel: "Komentaras ižininkystei (neprivalomas)",
      submit: "Pateikti užklausą išėmimui",
      useMax: "Naudoti maksimumą",
      success: "Užklausa sukurta. Ižininkystė paruoš operaciją po patikrinimo.",
      error: "Nepavyko sukurti užklausos. Bandykite vėliau.",
      validation: {
        amount: "Nurodykite sumą, didesnę už nulį.",
        destination: "Nurodykite piniginės adresą.",
        destinationInvalid: "Įveskite galiojantį Ethereum adresą.",
        insufficient: "Nepakanka lėšų vidiniame balanse.",
        destinationBlocked: "Šis adresas užblokuotas vidaus atitikties.",
        dailyLimit: "Viršytas dienos išėmimo limitas.",
        monthlyLimit: "Viršytas mėnesio išėmimo limitas.",
      },
      table: {
        title: "Išėmimo užklausų istorija",
        empty: "Jūs dar neturite jokių išėmimo užklausų.",
        columns: {
          amount: "Suma",
          destination: "Adresas",
          status: "Būsena",
...
<p>Jūs esat pilnībā atbildīgs par savu MetaMask maciņa un privāto atslēgu drošību. Mēs nevaram atgūt līdzekļus, kas zaudēti jūsu maciņa kompromitēšanas dēļ.</p>`,
    ...
    internalPayout: {
      badge: "Valsts kase",
      title: "Izņemšana uz korporatīvo maciņu",
      description:
        "Izveidojiet pieprasījumu un norādiet izņemšanas adresi. Atlikums tiek rezervēts uzreiz, un valsts kases komanda apstiprina transakciju manuāli.",
      helper: "Pieprasījumi tiek apstrādāti 2 stundu laikā. Par statusu informēsim pa e-pastu/Telegram.",
      amountLabel: "Summa žetonos",
      addressLabel: "Maciņa adrese izņemšanai",
      noteLabel: "Komentārs valsts kasei (nav obligāts)",
      submit: "Iesniegt izņemšanas pieprasījumu",
      useMax: "Izmantot maksimumu",
      success: "Pieprasījums izveidots. Valsts kase sagatavos transakciju pēc pārbaudes.",
      error: "Neizdevās izveidot pieprasījumu. Lūdzu, mēģiniet vēlāk.",
      validation: {
        amount: "Norādiet summu, kas lielāka par nulli.",
        destination: "Norādiet maciņa adresi.",
        destinationInvalid: "Ievadiet derīgu Ethereum adresi.",
        insufficient: "Nepietiek līdzekļu iekšējā atlikumā.",
        destinationBlocked: "Šī adrese ir bloķēta iekšējās atbilstības.",
        dailyLimit: "Pārsniegts dienas izņemšanas limits.",
        monthlyLimit: "Pārsniegts mēneša izņemšanas limits.",
      },
      table: {
        title: "Izņemšanas pieprasījumu vēsture",
        empty: "Jums vēl nav izņemšanas pieprasījumu.",
        columns: {
          amount: "Summa",
          destination: "Adrese",
          status: "Statuss",
