-- ============================================
-- Newsletter Tables Migration for Neon SQL Editor
-- Скопируйте весь этот код и выполните в Neon SQL Editor
-- ============================================

-- 1. Проверка и создание функции update_updated_at_column (если не существует)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 2. Создание таблицы newsletter_subscribers
...
-- 3. Создание таблицы newsletter_campaigns
...
-- 4. Создание таблицы newsletter_logs
